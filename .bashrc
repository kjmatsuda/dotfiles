...
alias pd='pushd'
alias t='tmux'
alias emin='emacs -q -l ~/.emacs.min.el'

# 2020/04/23 X Window Server
umask 022
# 2021/12/25 WSL2に移行したのに合わせてDISPLAYの設定を変更する
...
# wsldl で起動すると、初期表示時にホームを開けないのでホームに移動
if [ "$(pwd)" = "/mnt/c/Users/kjmat/AppData/Local/Ubuntu" ] || [ "$(pwd)" = "/mnt/c/Users/kjmat/wsl/ubuntu" ]; then
    cd ~/
fi
